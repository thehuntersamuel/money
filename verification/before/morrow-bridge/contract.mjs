...
export function buildStateProjection(book, trades, watchlist, proposals, quotes, verifiedAt) {
  ...
  return {
    ...
    book: {
      ...
      buying_power: Number(book.buying_power || 0),
      cash: Number(book.cash || 0),
      securities: Number(book.securities || 0),
      realized_pnl: Number(book.realized_pnl || 0),
      unrealized_pnl: Number(book.unrealized_pnl || 0),
    },
