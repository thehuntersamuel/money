...
async function main(){
 ...
 const symbols=streamUniverse((env.MORROW_SYMBOLS||'SPY').split(',').map(s=>s.trim()));
 ...
 const loadSymbols=subscriptionLoader({url,serviceRole:env.SUPABASE_SERVICE_ROLE_KEY,seed:symbols,resolveSymbols});
